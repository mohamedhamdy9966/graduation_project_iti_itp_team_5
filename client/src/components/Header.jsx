...
const Header = () => {
  return (
    <div className="flex flex-col md:flex-row items-center bg-blue-500 rounded-lg px-6 md:px-10 lg:px-20 overflow-hidden">
      <Helmet>
        <title>Book Appointments - Roshetta</title>
        <meta
          name="description"
          content="Book appointments with trusted doctors, labs, and pharmacies on Roshetta. Simplify your healthcare journey with our easy-to-use platform."
        />
        <meta
          name="keywords"
          content="book appointments, healthcare, doctors, labs, pharmacies, Roshetta"
        />
        <link rel="canonical" href="https://www.roshetta.com/" />
        <meta property="og:title" content="Book Appointments - Roshetta" />
        <meta
