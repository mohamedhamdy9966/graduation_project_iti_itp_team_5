...
import { Heart, Shield, Clock, Users, Star, CheckCircle, Award, TrendingUp, Zap, Globe, Stethoscope, Brain, Eye, Target, Rocket, ArrowRight, Play, Pause } from 'lucide-react';
...
const About = () => {
  ...
  const assets = {
    ...
    visita_concept: "https://images.unsplash.com/photo-1576091160399-112ba8d25d1f?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80",
    sheizlong_concept: "https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80",
    integration: "https://images.unsplash.com/photo-1582213782179-e0d53f98f2ca?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
    team1: "https://images.unsplash.com/photo-1612349317150-e413f6a5b16d?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80",
    team2: "https://images.unsplash.com/photo-1594824476967-48c8b964273f?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80",
    team3: "https://images.unsplash.com/photo-1582750433449-648ed127bb54?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80"
  };
  ...
  const integrationStory = [
    {
      ...
      description: "Leading-edge medical consultations, diagnostics, and specialized care connecting patients with world-class physicians.",
    ...
    },
    {
      ...
      description: "Revolutionary mental health platform offering therapy, counseling, and psychological support through innovative digital solutions.",
    ...
    },
    {
      ...
      description: "The seamless integration creating the world's first truly holistic healthcare platform, treating mind and body as one.",
  ...
  const stats = [
    { icon: TrendingUp, number: "3.2M+", label: "Lives Transformed", description: "Combined user base", delay: "delay-0" },
    { icon: Users, number: "12K+", label: "Healthcare Professionals", description: "Medical & Mental Health", delay: "delay-100" },
    { icon: Star, number: "150+", label: "Specializations", description: "Integrated Disciplines", delay: "delay-200" },
    { icon: Award, number: "99.9%", label: "Platform Reliability", description: "Uptime Excellence", delay: "delay-300" }
  ];

  const milestones = [
    { year: "2019", event: "Visita Founded", description: "Medical consultation platform launched" },
    { year: "2021", event: "Sheizlong Established", description: "Mental health platform revolutionizes care" },
    { year: "2024", event: "Strategic Merger", description: "Visita and Sheizlong unite for integrated healthcare" },
    { year: "2025", event: "Roshetah Launch", description: "Complete healthcare ecosystem goes live" }
  ];
        ...
        <div className="max-w-7xl mx-auto text-center">
          <div className="space-y-8 slide-up">
            ...
            <div className="relative inline-block mb-8">
              ...
              <div className="absolute -bottom-4 -left-4 w-4 h-4 bg-gradient-to-r from-blue-500 to-cyan-400 rounded-full floating" style={{ animationDelay: '1s' }}></div>
            </div>
            ...
            <div className="space-y-4">
              <p className="text-2xl md:text-4xl font-bold text-gray-800">
                Where <span className="text-blue-600">Visita</span> meets <span className="text-purple-600">Sheizlong</span>
              </p>
              <p className="text-xl md:text-2xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
                The revolutionary merger creating the world's first truly integrated healthcare ecosystem
              </p>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center pt-8">
              <button className="group relative px-12 py-6 bg-gradient-to-r from-cyan-500 to-teal-500 text-white text-xl font-bold rounded-full overflow-hidden transition-all duration-500 transform hover:scale-110 hover:shadow-2xl">
                <span className="relative z-10 flex items-center gap-2">
                  Explore Integration <ArrowRight className="w-5 h-5 group-hover:translate-x-2 transition-transform" />
                </span>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Witness the revolutionary merger that's reshaping healthcare forever
            </p>
          </div>
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center min-h-[600px]">
                  ...
                  return activeSection === index ? (
                    <div key={index} className="space-y-6">
                      <div className="flex items-center gap-4">
                        <div className={`w-16 h-16 bg-gradient-to-r ${story.color} rounded-2xl flex items-center justify-center shadow-lg`}>
                          <IconComponent className="w-8 h-8 text-white" />
                        </div>
                        <div>
                          <h3 className="text-4xl font-bold text-gray-800">{story.title}</h3>
                          <p className={`text-lg font-semibold bg-gradient-to-r ${story.color} bg-clip-text text-transparent`}>
                            {story.subtitle}
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-center gap-4 pt-4">
                        <div className={`h-1 w-20 bg-gradient-to-r ${story.color} rounded-full`}></div>
                        <span className="text-sm text-gray-500 font-medium">Step {index + 1} of 3</span>
                      </div>
                    </div>
                  ) : null;
                })}
              ...
              <div className="relative">
                <div className="relative rounded-3xl overflow-hidden shadow-2xl transform hover:scale-105 transition-transform duration-700">
                  ...
                  />
                  <div className={`absolute inset-0 bg-gradient-to-r ${integrationStory[activeSection].color} opacity-20`}></div>
                  <div className="absolute inset-0 shimmer opacity-30"></div>
                </div>
                <div className={`absolute -bottom-6 -right-6 w-24 h-24 bg-gradient-to-r ${integrationStory[activeSection].color} rounded-3xl shadow-xl floating`}></div>
                <div className="absolute -top-6 -left-6 w-16 h-16 bg-gradient-to-br from-pink-400 to-rose-500 rounded-2xl shadow-lg floating" style={{ animationDelay: '1s' }}></div>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-2 gap-12">
            {coreFeatures.map((feature, index) => {
              ...
              return (
                ...
                >
                  <div className={`absolute top-4 right-4 px-3 py-1 text-xs font-semibold bg-gradient-to-r ${feature.color} text-white rounded-full opacity-80`}>
                    {feature.badge}
                  </div>

                  <div className={`absolute top-0 right-0 w-40 h-40 bg-gradient-to-br ${feature.color} rounded-full opacity-10 -translate-y-20 translate-x-20 group-hover:scale-150 transition-transform duration-700`}></div>

                  <div className={`relative z-10 w-20 h-20 bg-gradient-to-br ${feature.color} rounded-2xl flex items-center justify-center mb-8 group-hover:scale-110 transition-transform duration-300 shadow-lg`}>
      ...
      <section className="py-32 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-gray-900 via-blue-900 to-purple-900 text-white relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="text-center mb-16">
            ...
            <p className="text-xl opacity-90">The power of integration in numbers</p>
          </div>
      ...
      <section className="py-32 px-4 sm:px-6 lg:px-8 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-20">
            ...
            <p className="text-xl text-gray-600">The path to healthcare revolution</p>
          </div>
              ...
              <div key={index} className={`relative flex items-center mb-16 ${index % 2 === 0 ? 'justify-start' : 'justify-end'}`}>
                <div className={`w-1/2 ${index % 2 === 0 ? 'pr-8 text-right' : 'pl-8'}`}>
                  <div className="bg-white rounded-2xl p-8 shadow-xl border border-gray-100 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
                    ...
                    <div className="text-xl font-semibold text-gray-800 mb-3">{milestone.event}</div>
        ...
        <div className="max-w-5xl mx-auto text-center relative z-10">
          <div className="space-y-8 slide-up">
            ...
            <p className="text-xl md:text-2xl mb-12 opacity-90 leading-relaxed max-w-4xl mx-auto">
              Join millions who have discovered the power of integrated healthcare. Where Visita's medical excellence meets Sheizlong's mental wellness innovation.
            </p>
            ...
            <div className="pt-12 flex justify-center space-x-12 opacity-80">
              ...
              <div className="text-center">
                <div className="text-2xl font-bold text-purple-400">Sheizlong</div>
